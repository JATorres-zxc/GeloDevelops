      ...
      <div className="max-w-6xl mx-auto">
                ...
                <div key={step.number} className="relative">
                  ...
                  <div className="text-center">
                    <div className="flex justify-center mb-4">
                      <div className="w-16 h-16 bg-secondary dark:bg-secondary rounded-full flex items-center justify-center">
        ...
        <div className="lg:hidden space-y-8">
          {steps.map((step, index) => (
            <div
              key={step.number}
              className="bg-card dark:bg-card p-6 rounded-xl transition-all duration-300 hover:shadow-lg"
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="w-12 h-12 bg-secondary dark:bg-secondary rounded-full flex items-center justify-center">
